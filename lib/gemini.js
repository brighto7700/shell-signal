...
export async function summarizeStory(title, url) {
  ...
  const prompt = `You are a senior developer analyzing Hacker News trends. Based ONLY on this headline: "${title}", provide 3 brief bullet points (under 10 words each) speculating on the technical implications or why devs care about this. Format: just the 3 bullets, nothing else.`;
